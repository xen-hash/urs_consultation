/**
 * Navi — the URS Consultation mascot.
 *
 * The artwork is cut from the character sheet in design/navi-sheet.webp by
 * design/cut-navi.py. The sheet stays out of frontend/public deliberately: it
 * is 434 KB of source art and shipping it would put it in the service worker's
 * precache alongside the eight assets that are actually used. Re-run the script
 * after editing the sheet; it writes straight into public/mascot.
 *
 ...
 *   idle      at rest, waiting to be asked. The closed help bubble.
...
const POSES = {
  helpful:   { src: "/mascot/navi-helpful.png",   ratio: 1 },
  happy:     { src: "/mascot/navi-happy.png",     ratio: 1 },
  idle:      { src: "/mascot/navi-idle.png",      ratio: 1 },
  thinking:  { src: "/mascot/navi-thinking.png",  ratio: 1 },
  listening: { src: "/mascot/navi-listening.png", ratio: 1 },
