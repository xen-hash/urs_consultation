...
import api, { isUnreachable } from "@urs/shared/lib/httpClient.js";
...
import { adminTour } from "@urs/shared/ui/tours.js";
import { useStats, useDepartments, usePagedResource } from "./sections/hooks.js";
import { announceNew, resetAnnounced, setMuted } from "./sections/announcer.js";

import OverviewTab from "./sections/OverviewTab.jsx";
import FacultyTab from "./sections/FacultyTab.jsx";
import CredentialsTab from "./sections/CredentialsTab.jsx";
import StudentsTab from "./sections/StudentsTab.jsx";
import RequestsTab from "./sections/RequestsTab.jsx";
import AuditTab from "./sections/AuditTab.jsx";
...
export default function DeanDashboard() {
  ...
  // Navi opens a section directly — /dashboard#credentials. See useHashTab.
  useHashTab("/dashboard", setTab);
  ...
  return (
    <div className="min-h-dvh bg-canvas lg:flex">
      ...
      <ConfirmSplash
        ...
        tone="brand"
        onDone={() => { clearSession(); navigate("/", { replace: true }); }}
      />
