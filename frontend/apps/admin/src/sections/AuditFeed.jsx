...
import { formatAgo, formatDateTime } from "@urs/shared/ui/datetime.js";
import { EmptyState, SkeletonRows } from "@urs/shared/SharedUI.jsx";
import {
...
const ACTION_META = {
  ...
  "admin.reset_pin":          { icon: KeyRound,    tone: "warning", label: "Faculty PIN reset" },
  "admin.reset_student_pin":  { icon: KeyRound,    tone: "warning", label: "Student PIN reset" },
  "admin.delete_student":     { icon: Trash2,      tone: "danger",  label: "Student removed" },
