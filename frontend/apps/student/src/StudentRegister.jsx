...
import { Toast, useToastState, Button, Alert, ConfirmSplash } from "@urs/shared/SharedUI.jsx";
...
import { DEPARTMENTS, YEAR_LEVELS } from "@urs/shared/lib/constants.js";
    ...
    <URSBackground>
      ...
      <nav className="sticky top-0 z-30 header-on-backdrop pt-safe">
        <div className="flex items-center gap-3 px-4 sm:px-6 py-3 w-full">
          ...
          <Link to="/sign-in" className="btn btn-ghost-light btn-sm shrink-0">
