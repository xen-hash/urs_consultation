...
// Used as a Tailwind *preset*, not a config: the three apps each have a
// tailwind.config.js that lists their own files and then defers to this for
// every design decision. One place to change a colour, three apps that change.
