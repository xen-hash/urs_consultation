...
SCHEMA = [
    ...
    """,
    # One row per thing a person should be told about. Recipients are addressed
    # by (role, id) rather than a foreign key because the two audiences live in
    # different tables — students.student_id and teacher_accounts.employee_id —
    # and the rest of this schema already joins across them by string.
    """
...
INDEXES = [
    ...
    # Every dashboard asks "what is mine, newest first" and "how many unread".
    "CREATE INDEX IF NOT EXISTS idx_notif_recipient ON notifications "
    "(recipient_role, recipient_id, created_at DESC)",
    "CREATE INDEX IF NOT EXISTS idx_notif_unread ON notifications "
    "(recipient_role, recipient_id) WHERE read_at IS NULL",
]
